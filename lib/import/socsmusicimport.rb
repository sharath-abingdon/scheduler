...
if fixture_set.empty?
  ...
  (start_date..end_date).each do |date|
    ...
    wanted.each do |fixture|
      ...
      existing_event = existing_events.detect { |e| e.source_id.to_s == fixture.lesson_id }
      ...
      unless subject
        puts "Subject with name '#{instrument_name}' not found, skipping subject association." if options.verbose
      else
